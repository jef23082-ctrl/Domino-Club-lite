import { OpeningMascotState } from './opening-mascot-state.js?v=20260924T185554830';
import { playPigGrunt, stopPigGrunt } from './sound-player.js?v=20260924T185554830';
...
export function createOpeningMascot({ stage, shell, notify = () => {} }) {
  ...
  async function ensureModel(){
    ...
    try {
      const { Pig3D }=await import('./mascot/pig3d.js?v=20260924T185554830');
