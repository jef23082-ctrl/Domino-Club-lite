...
import { knownCharacterIdForProfile } from '../online/profile-map.js?v=20260922T161100427';
...
import { createPremiumCrown, createPremiumPig } from './premium-symbols.js?v=20260922T161100427';
...
export function avatar(profile, { portrait = true } = {}) {
  ...
  if (/^data:image\/(png|jpeg|webp|gif);base64,/i.test(value)) { const image = element('img'); image.src=value; image.alt=displayName(profile.name || 'Avatar'); box.append(image); }
